...
import { Image, StyleSheet, ScrollView,Text, View, Dimensions,  TouchableOpacity,KeyboardAvoidingView } from 'react-native';
            ...
            <KeyboardAvoidingView behavior='padding' enabled>
                <ScrollView>
                    ...
                    <View style={{ height: 300, backgroundColor: "#000" }}>
                        <Image style={{ width: windowWidth, height: 300, marginLeft: 10 }} resizeMode="cover" source={{ uri: detail.petDetails.image }}></Image>
                    </View>
                    ...
                    <View>
                        ...
                        <View style={styles.row}>
                            ...
                            <Text style={{paddingLeft:10}}>{detail.petDetails.name}</Text>
                        </View>
                        <View style={styles.row}>
                            <Text style={{color:'red',marginRight:5}}> </Text>
                        ...
                        <View style={styles.row}>
                            ...
                            <Text style={{paddingLeft:10}}>{detail.petDetails.decription}</Text>
                        </View> 
                    </View>
